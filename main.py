...
from bot_func.get_info_in_yfinanse import start_info_command, button_handler
...
def main() -> None:
    ...
    application.add_handler(CallbackQueryHandler(button_handler, pattern="^Aksiyalar"))
